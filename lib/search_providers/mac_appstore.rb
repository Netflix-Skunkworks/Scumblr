...
class SearchProvider::MacAppstore < SearchProvider::Provider
  def self.provider_name
    "Mac App Store Search"
  end

  def self.description
    "Search the Apple Mac App Store and create results"
  end
  ...
  def run
    ...
    url = URI.escape('https://itunes.apple.com/search?entity=macSoftware&term=' + @query + '&limit=' + @options[:results].to_s)
